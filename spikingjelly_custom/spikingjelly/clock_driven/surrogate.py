...
class PiecewiseLeakyReLU(MultiArgsSurrogateFunctionBase):
    def __init__(self, w=1., c=0.01, spiking=True):
        ...
        * :ref:`API in English <PiecewiseLeakyReLU.__init__-en>`
        ...
        该函数在文章 [#yin2017algorithm]_ [#STBP]_ [#huh2018gradient]_ [#wu2019direct]_ [#Attention]_ [#roy2019scaling]_ [#LISNN]_ [#DECOLLE]_ 中使用。
        ...
        * :ref:`中文API <PiecewiseLeakyReLU.__init__-cn>`
        ...
        The function is used in [#yin2017algorithm]_ [#STBP]_ [#huh2018gradient]_ [#wu2019direct]_ [#Attention]_ [#roy2019scaling]_ [#LISNN]_ [#DECOLLE]_.
        '''
