...
class QIFNode(BaseNode):
    def __init__(self, tau: float = 2., v_c: float = 0.8, a0: float = 1., v_threshold: float = 1., v_rest: float = 0., v_reset: float = -0.1,
        ...
        * :ref:`中文API <QIFNode.__init__-cn>`
        ...
        The Quadratic Integrate-and-Fire neuron is a kind of nonlinear integrate-and-fire models_old and also an approximation of the Exponential Integrate-and-Fire model.
        The subthreshold neural dynamics of it is as followed:
...
class EIFNode(BaseNode):
    def __init__(self, tau: float = 2., delta_T: float = 1., theta_rh: float = .8, v_threshold: float = 1., v_rest: float = 0., v_reset: float = -0.1,
        ...
        * :ref:`中文API <EIFNode.__init__-cn>`
        ...
        The Exponential Integrate-and-Fire neuron is a kind of nonlinear integrate-and-fire models_old and also an one-dimensional model derived from the Hodgkin-Huxley model. It degenerates to the LIF model when :math:`\\Delta_T\\to 0`
        The subthreshold neural dynamics of it is as followed:
